...
function ResetPasswordContent() {
    ...
    if (success) {
        return (
            <AuthContainer>
                <Card className="relative glass-card border-white/20 dark:border-white/10 rounded-[2rem] overflow-hidden shadow-2xl p-8 text-center space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <Input 
                                    ...
                                    {...register("email")} 
                                    readOnly={!!emailParam}
                                    className={`h-12 bg-background/50 border-white/20 rounded-xl focus:ring-primary/20 ${!!emailParam ? "opacity-70 cursor-not-allowed" : ""}`} 
                                />
                            ...
                            <div className="space-y-2">
                                ...
                                <Input 
                                    ...
                                    {...register("otp")} 
                                    readOnly={!!otpParam}
                                    className={`h-12 bg-background/50 border-white/20 rounded-xl focus:ring-primary/20 ${!!otpParam ? "opacity-70 cursor-not-allowed" : ""}`} 
                                />
