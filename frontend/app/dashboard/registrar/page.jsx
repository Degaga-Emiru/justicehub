            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card className="glass-card hover:border-emerald-500/30 transition-all duration-500 overflow-hidden relative group">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs font-bold text-muted-foreground/60 uppercase tracking-tight mt-1">Available for assignment</p>
                    </CardContent>
                </Card>
                ...
                <Card className="glass-card hover:border-purple-500/30 transition-all duration-500 overflow-hidden relative group">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs font-bold text-muted-foreground/60 uppercase tracking-tight mt-1">In the registry</p>
                    </CardContent>
                </Card>
            </div>
