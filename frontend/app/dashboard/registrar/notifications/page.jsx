...
import { 
  ...
  Loader2, Info, FileText, CreditCard, Trash2 
} from "lucide-react";
import {
  Dialog,
  DialogContent,
...
export default function RegistrarNotificationsPage() {
  ...
  const markReadMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries(["registrar-notifications"]);
    },
  ...
  return (
    <div className="space-y-8 animate-fade-up max-w-4xl mx-auto pb-20 p-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-4xl font-black font-display tracking-tight text-foreground mb-2">Registrar Alerts</h1>
