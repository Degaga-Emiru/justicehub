        ...
        <div className="space-y-6 animate-in fade-in duration-500 max-w-4xl">
            ...
            <div className="space-y-4">
                {isLoading ? (
                    ...
                    <div className="py-16 text-center text-muted-foreground border-2 border-dashed border-white/5 rounded-2xl flex flex-col items-center justify-center gap-2 bg-muted/10">
