            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                <Card className="glass-card hover:border-primary/30 transition-all duration-500 overflow-hidden relative group">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs font-bold text-muted-foreground/60 uppercase tracking-tight mt-1">Assigned &amp; In Progress</p>
                    </CardContent>
                </Card>
                ...
                <Card className="glass-card hover:border-primary/30 transition-all duration-500 overflow-hidden relative group">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs font-bold text-muted-foreground/60 uppercase tracking-tight mt-1">{t("awaitingRegistrar")}</p>
                    </CardContent>
                </Card>
                ...
                <Card className={cn(
                    ...
                    <CardContent className="relative z-10">
                        ...
                        {awaitingPayment.length > 0 ? (
                            ...
                            <p className="text-xs font-bold text-muted-foreground/60 uppercase tracking-tight mt-1">No pending fees</p>
                        )}
                    </CardContent>
                </Card>
                ...
                {rejectedCases.length > 0 ? (
                    ...
                    <Card className="glass-card hover:border-primary/30 transition-all duration-500 overflow-hidden relative group">
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs font-bold text-muted-foreground/60 uppercase tracking-tight mt-1">{t("next30Days")}</p>
                        </CardContent>
                    </Card>
                )}
            </div>
                                        ...
                                        <div className="space-y-2 flex-1">
                                            ...
                                            {caseItem.status === "REJECTED" && caseItem.rejection_reason && (
                                                <div className="flex items-start gap-2 p-3 mt-3 rounded-xl bg-destructive/5 border border-destructive/10 animate-in fade-in duration-500">
                                                    ...
                                                    <p className="text-xs font-bold text-destructive/80 leading-relaxed capitalize">
