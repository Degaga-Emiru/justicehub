            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {isLoadingDocuments ? (
                    ...
                    activeCaseId && !isLoadingDocuments ? (
                        <div className="col-span-full py-12 text-center text-muted-foreground border-2 border-dashed border-white/5 rounded-2xl flex flex-col items-center justify-center gap-2 bg-muted/10">
