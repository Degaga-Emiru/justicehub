                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        {isLoading ? (
                            ...
                            <div className="text-center py-16 text-muted-foreground border-2 border-dashed border-white/5 rounded-2xl flex flex-col items-center justify-center gap-2 bg-muted/10">
