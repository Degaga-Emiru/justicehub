...
export default function ClientCaseDetailPage() {
 ...
 <p className="text-sm font-black text-slate-300 uppercase tracking-widest">Gathering Case Records...</p>
 </div>
 );
 }
 ...
 <div className="flex items-center gap-4 text-sm font-medium text-slate-300 pt-1">
 ...
 <div className="space-y-1">
 <p className="text-[10px] font-black uppercase tracking-widest text-slate-300">Case Priority</p>
 ...
 <div className="space-y-1">
 <p className="text-[10px] font-black uppercase tracking-widest text-slate-300">Court assigned</p>
 <p className="text-sm font-bold text-white truncate">{caseData.court_name || "Lideta Federal Court"}</p>
 </div>
 <div className="space-y-1">
 <p className="text-[10px] font-black uppercase tracking-widest text-slate-300">Processing Fee</p>
 ...
 <div className="space-y-3">
 <h3 className="text-xs font-black uppercase tracking-widest text-slate-300 flex items-center gap-2 px-2">
 ...
 <h3 className="text-xs font-black uppercase tracking-widest text-slate-300 flex items-center gap-2 px-2 pt-4">
 ...
 <span className="text-[10px] font-black text-slate-300 uppercase">{doc.document_type}</span>
 </div>
 </div>
 ...
 <p className="text-xs italic text-slate-300 border-white/5 border border-dashed rounded-xl p-6 text-center">No evidentiary files recorded for this filing.</p>
 )}
 </div>
 </div>
 </CardContent>
 ...
 <span className="text-[10px] font-black uppercase tracking-widest text-slate-200">{format(new Date(event.date), "PPP")}</span>
 </div>
 ...
 <p className="text-sm italic text-slate-300 text-center py-10">Waiting for judicial action to populate timeline...</p>
 )}
 </CardContent>
 </Card>
 </div>
 ...
 <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-300">Case Involvement</CardTitle>
 </CardHeader>
 ...
 <p className="text-[10px] text-slate-300 font-black uppercase truncate">{user?.email}</p>
 </div>
 </div>
 </div>
 ...
 <p className="text-[10px] text-slate-300 font-black uppercase tracking-tight">External Non-User</p>
 </div>
 </div>
 ...
 <p className="text-[11px] font-medium text-slate-300 leading-relaxed">{caseData.defendant.address}</p>
 </div>
 )}
 </div>
 </CardContent>
 ...
 <div>
 <p className="text-[10px] font-black text-slate-300 uppercase leading-none">Judge Assigned</p>
 ...
 <div>
 <p className="text-[10px] font-black text-slate-300 uppercase leading-none">Current Phase</p>
 ...
 <DialogDescription className="text-slate-300 font-medium">Please select a payment method for case: <span className="text-foreground font-bold">{caseData?.title}</span></DialogDescription>
 </DialogHeader>
 
 <div className="py-4 space-y-5">
 <div className="flex justify-between items-center p-5 bg-primary/10 rounded-2xl border border-primary/20">
 <span className="text-xs font-black uppercase tracking-widest text-slate-300">Total Fee</span>
 ...
 <CreditCard className={cn("h-5 w-5", paymentMethod === "chapa" ? "text-emerald-500" : "text-slate-200")} />
 <span className="font-black text-sm">Chapa Pay</span>
 </div>
 <p className="text-[11px] text-slate-300 font-medium">Instant online (Visa/MC/M-Pesa)</p>
 </button>
 <button
 type="button"
 ...
 >
 <div className="flex items-center gap-2">
 <Banknote className={cn("h-5 w-5", paymentMethod === "bank" ? "text-blue-500" : "text-slate-200")} />
 <span className="font-black text-sm">Bank Transfer</span>
 </div>
 <p className="text-[11px] text-slate-300 font-medium">Digital receipt verification</p>
 </button>
 </div>
 ...
 <Label className="text-[10px] font-black uppercase tracking-widest text-slate-300 ml-1">Reference Number *</Label>
 <Input 
 ...
 <div className="space-y-2">
 <Label className="text-[10px] font-black uppercase tracking-widest text-slate-300 ml-1">Account Holder Name *</Label>
 <Input 
