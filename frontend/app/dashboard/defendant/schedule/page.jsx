...
export default function DefendantSchedulePage() {
    ...
    return (
        <div className="space-y-8 animate-fade-up pb-20">
            <div>
                <h1 className="text-3xl font-black font-display tracking-tight text-white mb-2">Hearing Schedule</h1>
            ...
            <div className="space-y-6">
                {isLoading ? (
                    ...
                    hearings.map((hearing) => (
                        <Card 
                            key={hearing.id} 
                            className="glass-card border-white/5 shadow-xl hover:border-primary/20 transition-all duration-300 overflow-hidden group"
                        >
                                ...
                                <CardContent className="flex-1 p-8">
                                    <div className="flex flex-col md:flex-row justify-between gap-6">
                                        <div className="space-y-4">
                                            ...
                                            <h3 className="text-xl font-black text-white tracking-tight">{hearing.title}</h3>
                    ...
                    <div className="flex flex-col items-center justify-center py-40 space-y-4 opacity-40">
                        ...
                        <p className="text-lg font-bold text-white">No hearings scheduled</p>
