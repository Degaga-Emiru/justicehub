...
export default function DefendantNotificationsPage() {
 ...
 <p className="text-slate-300 font-medium">Clear communication on your case progression.</p>
 </div>
 <Button 
 variant="outline" 
 ...
 <p className="text-xs font-black uppercase tracking-widest text-slate-300">Syncing Alert Feed...</p>
 </div>
 ...
 <h3 className={cn("text-base font-bold", !notif.is_read ? "text-white" : "text-slate-200")}>
 {notif.title}
 </h3>
 <span className="text-[10px] font-black text-slate-300 uppercase py-1">
