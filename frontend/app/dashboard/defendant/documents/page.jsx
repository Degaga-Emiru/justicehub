...
export default function DefendantDocumentsPage() {
 ...
 <FolderOpen className="h-8 w-8 text-primary/90" />
 </div>
 </CardHeader>
 ...
 variant="outline" 
 size="sm" 
 className="rounded-xl border-primary/20 bg-primary/5 hover:bg-primary/10 text-primary flex-1 md:flex-none text-xs font-bold"
