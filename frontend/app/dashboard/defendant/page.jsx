        ...
        <div className="space-y-10 animate-fade-up">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
                <div className="space-y-1">
                    <h1 className="text-4xl font-black font-display tracking-tight text-foreground">Defense Command</h1>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                <Card className="glass-card hover:border-blue-500/30 transition-all duration-500 overflow-hidden relative group">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs font-bold text-muted-foreground/60 uppercase tracking-tight mt-1">Total Litigation</p>
                    </CardContent>
                </Card>
                ...
                <Card className={cn(
                    ...
                    <CardContent className="relative z-10">
                        ...
                        {pendingActions.length > 0 ? (
                            ...
                            <p className="text-xs font-bold text-muted-foreground/60 uppercase tracking-tight mt-1">All clear</p>
                        )}
                    </CardContent>
                </Card>
                ...
                <Card className="glass-card hover:border-emerald-500/30 transition-all duration-500 overflow-hidden relative group">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs font-bold text-muted-foreground/60 uppercase tracking-tight mt-1">Next 30 Days</p>
                    </CardContent>
                </Card>
                ...
                <Card className="glass-card hover:border-slate-500/30 transition-all duration-500 overflow-hidden relative group">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs font-bold text-muted-foreground/60 uppercase tracking-tight mt-1">Total Closed</p>
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-7">
                ...
                <Card className="col-span-4 glass-card border-white/10 shadow-xl overflow-hidden">
                    <CardHeader className="p-8 pb-4">
                        <div className="flex justify-between items-center">
                            <div className="space-y-1">
                                <CardTitle className="text-2xl font-black font-display tracking-tight">Active Disputes</CardTitle>
                                    ...
                                    >
                                        <div className="space-y-2 flex-1">
                                            ...
                                            <div className="flex items-center gap-4 text-xs font-bold text-muted-foreground uppercase tracking-widest leading-none">
                                                <span className="flex items-center gap-1.5"><FileText className="h-3 w-3" /> {caseItem.file_number || "F-PENDING"}</span>
                                                <span className="flex items-center gap-1.5"><Scale className="h-3 w-3" /> {caseItem.category?.name || caseItem.category || "General"}</span>
                                            </div>
                                        </div>
                ...
                <Card className="col-span-3 glass-card border-white/10 shadow-xl overflow-hidden flex flex-col">
                    <CardHeader className="p-8 pb-4">
                        <CardTitle className="text-2xl font-black font-display tracking-tight">Court Schedule</CardTitle>
                                ...
                                {myHearings.map((hearing) => (
                                    <div key={hearing.id} className="flex gap-5 items-center group">
                                        ...
                                        <div className="space-y-1.5 flex-1">
                                            ...
                                            <p className="text-xs font-bold text-muted-foreground truncate">{hearing.caseTitle || hearing.title || "Court Intake"}</p>
