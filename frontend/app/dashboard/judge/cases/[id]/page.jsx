                        ...
                        <CardContent className="p-8 space-y-8">
                            ...
                            <div className="space-y-6">
                                ...
                                {caseData.documents?.length > 0 ? (
                                                ...
                                                <div key={docId || i} className="flex items-center justify-between p-4 rounded-xl border border-white/5 bg-background/40 hover:bg-white/5 transition-all group">
                                                    <div className="flex items-center gap-3 min-w-0">
                                                        ...
                                                        <div className="flex flex-col min-w-0">
                                                            ...
                                                            <p className="text-[10px] font-black uppercase tracking-tighter text-muted-foreground/60">{doc.document_type}</p>
                                                        </div>
                                                    </div>
                                                    <Button 
                                                        variant="ghost" 
                                    ...
                                    <p className="text-sm text-center py-10 italic text-muted-foreground border border-dashed border-white/10 rounded-2xl">No evidentiary documents currently attached.</p>
                                )}
                            </div>
                        </CardContent>
                    </Card>
                                        ...
                                        <div key={idx} className="relative flex items-start gap-6 group">
                                            ...
                                            <div className="flex-1 pt-1 space-y-1">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">{format(new Date(event.date), "MMM d, yyyy")}</span>
                                                </div>
                                                <p className="text-xs text-muted-foreground font-medium italic">{event.description}</p>
                                                <p className="text-[10px] font-black text-primary/40 uppercase tracking-widest mt-1">Authorized by {event.user_role || "Registrar"}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                                ...
                                <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5 group hover:bg-white/10 transition-all">
                                    ...
                                    <div className="flex flex-col min-w-0">
                                        ...
                                        {caseData.defendant && caseData.defendant !== "PENDING_DEFENDANT" ? (
                                            <p className="text-xs text-rose-500/80 font-bold flex items-center gap-1.5 mt-1">
                                                <Shield className="h-3 w-3" /> System Account Linked
                                            </p>
                                        ) : (
                                            <p className="text-xs text-amber-500/80 font-bold flex items-center gap-1.5 mt-1 animate-pulse">
