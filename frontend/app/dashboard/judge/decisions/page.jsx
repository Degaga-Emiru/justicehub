                        ...
                        {selectedCaseId && (
                            <div className="space-y-3 pt-2">
                                ...
                                {decisionsLoading ? (
                                    ...
                                    <p className="text-xs font-bold text-muted-foreground text-center py-4 bg-muted/10 rounded-xl border border-dashed border-white/5">No decisions yet for this case.</p>
                                )}
                            </div>
                        )}
                    </CardContent>
                                ...
                                <TabsContent value="draft" className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative group">
                                            ...
                                            />
                                            <div className="absolute bottom-4 right-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground/50 bg-background/80 px-2 py-1 rounded-md backdrop-blur-md opacity-0 group-hover:opacity-100 transition-opacity">
                                ...
                                <TabsContent value="preview" className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                                    <div className="bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] rounded-2xl p-10 min-h-[500px] text-slate-900 shadow-inner font-serif border border-white/20">
                                        <div className="text-center mb-10 border-b-2 border-slate-200 pb-6">
                                            ...
                                            <p className="text-sm font-medium text-slate-500 mt-3 font-mono tracking-wider">Case No: {selectedCase.file_number || selectedCase.id}</p>
                                        </div>
                                        ...
                                        <div className="mb-8 text-slate-700">
                                            <p className="font-bold text-lg mb-1"><span className="text-slate-400">Re:</span> {selectedCase.title}</p>
                                            <p className="font-medium italic"><span className="text-slate-400 not-italic">Before:</span> Honorable {user?.first_name} {user?.last_name}</p>
                                            <p className="text-sm mt-1 font-medium"><span className="text-slate-400">Date:</span> {format(new Date(), "MMMM do, yyyy")}</p>
                                        </div>

                                        {introduction && (
                                            <div className="mb-10">
                                                <h4 className="font-black uppercase text-[10px] tracking-[0.2em] mb-4 text-slate-400 border-b border-slate-200 pb-2">I. Introduction</h4>
                                        ...
                                        {background && (
                                            <div className="mb-10">
                                                <h4 className="font-black uppercase text-[10px] tracking-[0.2em] mb-4 text-slate-400 border-b border-slate-200 pb-2">II. Background</h4>
                                                <div className="whitespace-pre-wrap leading-loose text-slate-800 text-base">
                                                    {background}
                                                </div>
                                            </div>
                                        ...
                                        <div className="mb-10">
                                            <h4 className="font-black uppercase text-[10px] tracking-[0.2em] mb-4 text-slate-400 border-b border-slate-200 pb-2">III. Analysis & Reasoning</h4>
                                            <div className="whitespace-pre-wrap leading-loose text-slate-800 text-lg">
                                                {analysis || <span className="text-slate-400 italic">[No content drafted yet]</span>}
                                            </div>
                                        </div>

                                        {conclusion && (
                                            <div className="mb-10">
                                                <h4 className="font-black uppercase text-[10px] tracking-[0.2em] mb-4 text-slate-400 border-b border-slate-200 pb-2">IV. Conclusion</h4>
                                                <div className="whitespace-pre-wrap leading-loose text-slate-800 text-base">
                                                    {conclusion}
                                                </div>
                                            </div>
                                        ...
                                        {order && (
                                            <div className="mb-10">
                                                <h4 className="font-black uppercase text-[10px] tracking-[0.2em] mb-4 text-slate-400 border-b border-slate-200 pb-2">V. Court Orders</h4>
                                        ...
                                        <div className="mt-16 pt-8 border-t-2 border-slate-200 w-1/3">
                                            <p className="mb-6 font-medium text-slate-500 italic">Signed,</p>
                                            ...
                                            <p className="text-[10px] font-black uppercase tracking-[0.2em] mt-3 text-slate-400">Presiding Judge</p>
                                        </div>
                                    </div>
                                </TabsContent>
