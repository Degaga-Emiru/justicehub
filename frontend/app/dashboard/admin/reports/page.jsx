            ...
            <div className="grid gap-6 md:grid-cols-4">
                ...
                <Card className="glass-card hover:border-purple-500/30 transition-all duration-500 overflow-hidden relative group">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs font-bold text-muted-foreground/60 uppercase tracking-tight mt-1">Currently active</p>
                    </CardContent>
                </Card>
                ...
                <Card className="glass-card hover:border-amber-500/30 transition-all duration-500 overflow-hidden relative group">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs font-bold text-muted-foreground/60 uppercase tracking-tight mt-1">Filing to verdict</p>
                    </CardContent>
                </Card>
                ...
                <Card className="glass-card hover:border-emerald-500/30 transition-all duration-500 overflow-hidden relative group">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs font-bold text-muted-foreground/60 uppercase tracking-tight mt-1">Fees processed</p>
                    </CardContent>
                </Card>
            </div>
                            ...
                            <CardContent className="p-8">
                                <div className="h-[300px]">
                                    {demographicData.length > 0 ? (
                                        ...
                                        <div className="flex flex-col h-full items-center justify-center text-muted-foreground border-dashed border-2 border-white/5 rounded-2xl space-y-2">
                            ...
                            <div className="grid md:grid-cols-2 gap-6 items-end pb-8 border-b border-white/5">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input 
                                        ...
                                        className="h-12 bg-background/50 border-white/20 rounded-xl focus:ring-primary/20 font-medium"
                                    />
                                    <p className="text-[10px] font-bold text-muted-foreground/60 uppercase tracking-tight ml-1">Leave bounds empty for sweeping historical reports.</p>
                                </div>
                            </div>
