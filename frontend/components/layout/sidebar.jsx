...
const menuKeys = {
  ...
  judge: [
    ...
    { key: "navNotifications", href: "/dashboard/judge/notifications", icon: Bell },
  ],
  clerk: [
    { key: "navDashboard", href: "/dashboard/clerk", icon: ClipboardList }, 
    { key: "navPayments", href: "/dashboard/clerk/payments", icon: CreditCard },
    { key: "navClosedCases", href: "/dashboard/clerk/closed-cases", icon: CheckCircle },
    { key: "navNotifications", href: "/dashboard/clerk/notifications", icon: Bell },
  ],
  admin: [
    ...
    { key: "navClosedCases", href: "/dashboard/registrar/closed-cases", icon: CheckCircle },
    { key: "navNotifications", href: "/dashboard/admin/notifications", icon: Bell },
  ...
  registrar: [
    ...
    { key: "navSearch", href: "/dashboard/registrar/search", icon: Search },
    { key: "navReports", href: "/dashboard/registrar/reports", icon: BarChart3 },
    { key: "navNotifications", href: "/dashboard/registrar/notifications", icon: Bell },
  ],
  defendant: [
...
export function Sidebar({ className }) {
  ...
  return (
    ...
    >
      <div className="absolute top-0 right-0 w-full h-[50%] bg-primary/10 rounded-full blur-[100px] -z-10 pointer-events-none "></div>
    ...
    <div className="flex flex-col h-full relative z-10">
          ...
          return (
            ...
            >
              ...
              <Icon className={cn(
                ...
                isActive ? "text-primary scale-110" : "text-slate-200 group-hover:text-white group-hover:scale-110"
              )} />
        ...
        <div className={cn(
          ...
          {!collapsed && (
            <div className="flex-1 min-w-0 animate-in fade-in duration-500">
              ...
              <p className="text-xs text-slate-200 truncate tracking-tight font-medium">{user.email}</p>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="p-4 pt-4 space-y-1 shrink-0">
        <Link
          ...
          className={cn(
            "flex items-center w-full p-3 px-4 rounded-xl text-slate-200 hover:text-white hover:bg-white/10 transition-all duration-300 group",
        ...
        <Button
          variant="ghost"
          className={cn("w-full justify-start text-slate-200 hover:text-white hover:bg-white/10 px-4", collapsed && "justify-center")}
