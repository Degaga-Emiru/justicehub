...
export function NotificationBell() {
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-96 glass-card border-white/10 shadow-2xl p-0 rounded-2xl overflow-hidden">
                <DropdownMenuLabel className="flex items-center justify-between px-6 py-4 border-b border-white/5">
                    ...
                    {notifications.length === 0 ? (
                        ...
                        notifications.map((n) => (
                            <div 
                                key={n.id} 
                                className={cn(
                                    "flex gap-4 px-6 py-4 border-b border-white/5 last:border-0 hover:bg-white/5 transition-all duration-200 cursor-pointer group",
