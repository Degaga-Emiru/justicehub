...
export function AuthForm({ type = "login", onTypeChange }) {
 ...
 <Input id="first_name" placeholder="John" {...register("first_name")} className="h-12 bg-background border-border rounded-xl focus:ring-primary/20" />
 ...
 <Input id="last_name" placeholder="Doe" {...register("last_name")} className="h-12 bg-background border-border rounded-xl focus:ring-primary/20" />
